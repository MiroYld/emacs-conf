# Generated by Powerlevel10k configuration wizard on 2025-06-03 at 16:07 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='|✍️ '
  ...
  function my_git_formatter() {
    ...
    # ⬅️42 if behind the push remote.
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}⬅️${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ➡️42 if ahead of the push remote; no leading space if also behind: ⬅️42➡️42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}➡️${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # ⭐42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}⭐${VCS_STATUS_STASHES}|"
    # 🔀 if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}🔀${VCS_STATUS_ACTION}|"
    # ⚠️42 if have merge conflicts.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}⚠️${VCS_STATUS_NUM_CONFLICTED}|"
